const translations = {
  uk: {
    ...
    "hero.eyebrow": "Rust-first засновник Yunexal",
    "hero.title": "Nestor (Pavlo) Churin",
    "hero.subtitle": "Створюю Rust-native self-hosted інструменти для інфраструктури.",
    "hero.description": "Батько проєкту Yunexal Panel. Проєктую швидкі Rust-системи й практичні інструменти для керування серверами та Docker-середовищем.",
    "hero.ageLabel": "Вік",
    ...
    "hero.signalStackValue": "Rust · Axum · Docker",
    "hero.metricTimeLabel": "Поточний час",
    "hero.metricYearsLabel": "Build mode",
    "hero.metricYearsValue": "Rust-first",
    ...
    "about.missionText": "Будувати надійні Rust-native інструменти, які допомагають запускати і підтримувати власну інфраструктуру без зайвої складності.",
    ...
    "about.focusItem3": "Спрощую self-hosted адміністрування через швидкий Rust-first продукт.",

    "projects.title": "Проєкти",
  "projects.kicker": "Флагманська робота",
    ...
    "projects.panelSummary": "Rust-native self-hosted платформа для керування серверами, побудована на Docker.",
  ...
  "projects.sideKicker": "Чому це важливо",
  "projects.statOneLabel": "Runtime model",
  "projects.statOneValue": "Rust single binary",
  "projects.statTwoLabel": "Deployment",
  "projects.statTwoValue": "Docker-native",
  "projects.statThreeLabel": "Позиціонування",
  "projects.statThreeValue": "Self-hosted control panel для сучасної інфраструктури",

  "skills.kicker": "Карта компетенцій",
    "skills.title": "Навички / Stack",
    "skills.lead": "Технології, з якими працюю зараз.",
  "skills.columnOneTitle": "Rust backend",
  "skills.columnTwoTitle": "Runtime + infra",
  "skills.columnThreeTitle": "Shipping mindset",

  "faq.kicker": "Потрібна коротка версія?",
    "faq.title": "FAQ",
  ...
  "contacts.kicker": "На зв'язку",
    "contacts.title": "Контакти",
    "contacts.lead": "Відкритий до співпраці та технічних обговорень.",
  "contacts.ctaKicker": "Найкраще для",
  "contacts.ctaTitle": "Rust-продуктів, infra tools і self-hosted систем, які треба швидко шипити.",
  "contacts.ctaEmail": "Написати на email",
  "contacts.ctaTelegram": "Відкрити Telegram",
  ...
  en: {
    ...
    "hero.eyebrow": "Rust-first founder of Yunexal",
    "hero.title": "Nestor (Pavlo) Churin",
    "hero.subtitle": "Building Rust-native self-hosted infrastructure tools.",
    "hero.description": "Father of the Yunexal Panel project. I design fast Rust systems and practical tools for server and Docker environment management.",
    "hero.ageLabel": "Age",
    ...
    "about.missionText": "Build reliable Rust-native tools that help people run and maintain their own infrastructure with less complexity.",
    ...
    "about.focusItem3": "Simplifying self-hosted administration through a fast Rust-first product.",

    "projects.title": "Projects",
  "projects.kicker": "Flagship work",
    "projects.lead": "Main public focus: Yunexal Panel.",
    "projects.cardLabel": "Featured project",
    "projects.repoCta": "GitHub repository",
    "projects.panelSummary": "Rust-native self-hosted server management platform built on Docker.",
  ...
  "projects.sideKicker": "Why it matters",
  "projects.statOneLabel": "Runtime model",
  "projects.statOneValue": "Rust single binary",
  "projects.statTwoLabel": "Deployment",
  "projects.statTwoValue": "Docker-native",
  "projects.statThreeLabel": "Positioning",
  "projects.statThreeValue": "Self-hosted control panel for modern infra",

  "skills.kicker": "Capability map",
  ...
  "faq.kicker": "Need the short version?",
    "faq.title": "FAQ",
  ...
  "contacts.kicker": "Reach out",
    "contacts.title": "Contacts",
    "contacts.lead": "Open to collaboration and technical discussions.",
  "contacts.ctaKicker": "Best for",
  "contacts.ctaTitle": "Rust products, infra tools, and self-hosted systems that need to ship fast.",
  "contacts.ctaEmail": "Email me",
  "contacts.ctaTelegram": "Open Telegram",
    "contacts.githubLabel": "GitHub",
  ...
  ru: {
    ...
    "hero.eyebrow": "Rust-first засновнік Yunexal. Украінєц. Нє запорєбрік, нє арк, нє «своіх нє бросаєм».",
    "hero.title": "Nestor (Pavlo) Churin",
    "hero.subtitle": "Пішу Rust-native self-hosted kod поки кацапи сідят в канаві і чєкают на «побєду».",
    "hero.description": "Украінєц. Поки орки «дємілітарізіруют» — я будую швидку Rust-інфру. Yunexal Panel нє здасца. Слава Украіні. Смєрть ворогам.",
    ...
    "about.missionTitle": "Місія",
    "about.missionText": "Будувати надійну Rust-native self-hosted інфру. Поки путлєрскіє орки окопуюца — я компілюю. Rust швидшє любого Т-72.",
    ...
    "about.focusItem3": "Self-hosted адмінка. Rust-first продукт. Украіна будє пєрємагати — і в коді тожє.",
  ...
  "projects.kicker": "Флагманська робота",
    ...
    "projects.panelSummary": "Rust-native self-hosted Docker-панєль. Нє злітає від однієї санкції.",
  ...
  "projects.sideKicker": "Чого це стоїть",
  "projects.statOneLabel": "Runtime",
  "projects.statOneValue": "Rust бінарь",
  "projects.statTwoLabel": "Deploy",
  "projects.statTwoValue": "Docker-native",
  "projects.statThreeLabel": "Позиціонування",
  "projects.statThreeValue": "Self-hosted control panel для сучасной інфри",

  "skills.kicker": "Карта скіллів",
  ...
  "contacts.kicker": "На звязку",
    "contacts.title": "Звязок",
    "contacts.lead": "Відкритий до співпраці. З людьми, нє з орками.",
  "contacts.ctaKicker": "Лучше всєго для",
  "contacts.ctaTitle": "Rust-продуктов, infra tools і self-hosted систем, коториє треба швидко шипить.",
  "contacts.ctaEmail": "Писать на email",
  "contacts.ctaTelegram": "Открить Telegram",
    "contacts.githubLabel": "GitHub",
